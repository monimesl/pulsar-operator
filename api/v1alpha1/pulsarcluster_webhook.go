...
// +kubebuilder:webhook:path=/mutate-pulsar-wirelimited-com-v1alpha1-pulsarcluster,mutating=true,failurePolicy=fail,groups=pulsar.wirelimited.com,resources=pulsarclusters,verbs=create;update,versions=v1alpha1,name=mpulsarcluster.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-pulsar-wirelimited-com-v1alpha1-pulsarcluster,mutating=false,failurePolicy=fail,groups=pulsar.wirelimited.com,resources=pulsarclusters,versions=v1alpha1,name=vpulsarcluster.kb.io
